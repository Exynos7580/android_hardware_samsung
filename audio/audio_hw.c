...
static int start_input_stream(struct stream_in *in)
{
    ...
    pcm_device->pcm = pcm_open(pcm_device->pcm_profile->card, get_pcm_device_id(uc_info->id, PCM_CAPTURE),
...
static int out_open_pcm_devices(struct stream_out *out)
{
    ...
    list_for_each(node, &out->pcm_dev_list) {
        ...
        pcm_device->pcm = pcm_open(pcm_device_card, get_pcm_device_id(uc_info->id, PCM_PLAYBACK),
